package com.project.demo.rest.reportProblem;
...
public class ReportProblemController {
    ...
    // Endpoint para obtener reportes por área del problema
    ...
    // Endpoint para crear un nuevo reporte de problema
    ...
    // Endpoint para actualizar un reporte de problema existente
    @PutMapping("/{id}")
    ...
    // Endpoint para eliminar un reporte de problema por ID
    @DeleteMapping("/{id}")
